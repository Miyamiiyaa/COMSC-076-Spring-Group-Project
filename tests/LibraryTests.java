...
public class LibraryTests {
        ...
        void init() {
                ...
                otherBook = new Book(TITLE_2, AUTHOR_2, ISBN_2, YEAR_2,
                                COPIES_2);
        }
        ...
        void testNumberOfBooksCountsUnique() {
                ...
                Book moreCopiesOfSameBook = new Book(TITLE, AUTHOR, ISBN,
                                YEAR, 5);
        ...
        void testAddExistingBook() {
                library.addBook(book);
                assertEquals(COPIES, library.findByISBN(ISBN)
                                .getNumberOfCopies());

                // match equality convention in Book (same title, author, ISBN
                // but with
                // a different copy count.
                Book sameIdentityMoreCopies = new Book(TITLE, AUTHOR, ISBN,
                                YEAR, 7);
        ...
        void testDuplicateIsbnDifferentBook() {
                ...
                Book collision = new Book("Wrong_Title", "Wrong_Author",
                                ISBN, YEAR, 5);
        ...
        void testFindByTitleAndAuthorNegative() {
                library.addBook(otherBook);
                assertThrows(NoSuchElementException.class,
                                () -> library.findByTitleAndAuthor(TITLE,
                                                AUTHOR),
        ...
        void testFindByTitleAndAuthorNull() {
                assertThrows(IllegalArgumentException.class,
                                () -> library.findByTitleAndAuthor(null,
                                                AUTHOR),
        ...
        void testSaveLoadRoundTrip(@TempDir Path tempDir) {
                ...
                String filename = tempDir.resolve("testlibrary.json")
                                .toString();
        ...
        void testLoadMalformedFile(@TempDir Path tempDir)
                        throws Exception {
